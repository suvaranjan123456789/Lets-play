...
// if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // $details=mysqli_query($conn,"SELECT fullname,email FROM registration_data WHERE email='$email_reg'");
    ...
    <div class="container">
      <div class="row"><br><br><br>
        ...
        <div class="col-md-4" style="background-color: #D2D1D1; border-radius:15px;">
          <br><br>
          <form role="form"action="forget_otp.php" method="POST">
            ...
            <?php if (isset($message_success)) {
              ...
              <button type="submit" class="btn btn-primary " name="submit" style="display: block; width: 60%; margin-top:15px;">Send Email</button>
              <br><br>
